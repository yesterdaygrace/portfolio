    ...
    >
      <div>
        <div className="max-w-4xl mb-12">
          ...
          >
            I am currently {profile.availability.toLowerCase()}. Open to
            full-stack engineering roles, contract system migrations, and
            high-reliability backend development.
          </p>
          ...
          <div className="flex flex-wrap gap-3 items-center mb-16">
            <a href={`mailto:${profile.email}`} className="vellum-btn-solid">
              Send an Email ↗
            </a>
            <a
        ...
        <div className="border border-[var(--c-border)] bg-[var(--c-bg-deep)] p-6 sm:p-8 mb-12">
          ...
          <div
            className="grid grid-cols-1 sm:grid-cols-3 gap-6 font-sans text-xs leading-relaxed"
            style={{ color: "var(--c-fg-2)" }}
          >
            <div>
            ...
            <div>
              ...
              <p>
                Slate #2E3344 field, muted terracotta #7E5246 accents, and warm
                ivory #F7F1E2 type. Zero gradients or decorative shadows.
              </p>
            </div>
            <div>
              <span className="font-mono text-[11px] block text-[var(--c-accent)] mb-1 uppercase">
              ...
              <p>
                Static Vite build deployed to GitHub Pages via automated GitHub
                Actions pipeline with strict supply-chain dependency pins.
              </p>
            </div>
          </div>
        </div>
